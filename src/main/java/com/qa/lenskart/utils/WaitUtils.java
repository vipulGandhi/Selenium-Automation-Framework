...
public class WaitUtils
{
	...
	// WebDriverWait will ignore NotFoundException by default.
		// NotFoundException is a sub class of WebDriverException
		// NoAlertPresentException, NoSuchContextException, NoSuchCookieException, NoSuchElementException, NoSuchFrameException,
			// NoSuchWindowException are direct sub classes of it
	...
	public boolean ifTextMatches(By byLocator, int waitForTimeinSeconds, String actualtext, String expectedtext)
	{
		WebDriverWait webDriverWait = new WebDriverWait(driver, Duration.ofSeconds(waitForTimeinSeconds));
		
		boolean isTextEqual = webDriverWait.until(new ExpectedCondition<Boolean>()
		{
			@Override
			public Boolean apply(WebDriver driver)
			{
				return driver.findElement(By.linkText(actualtext)).getText().equals(expectedtext);
			}
		});
